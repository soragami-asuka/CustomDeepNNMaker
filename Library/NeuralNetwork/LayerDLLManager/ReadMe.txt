========================================================================
    ダイナミック リンク ライブラリ: LayerDLLManager プロジェクトの概要
========================================================================

この LayerDLLManager DLL は、AppWizard により作成されました。

このファイルには、LayerDLLManager アプリケーションを構成する各ファイルの内容の概要が含まれています。


LayerDLLManager.vcxproj
...
LayerDLLManager.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、LayerDLLManager.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。
