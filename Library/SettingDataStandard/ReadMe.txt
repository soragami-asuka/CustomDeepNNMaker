========================================================================
    ダイナミック リンク ライブラリ: SettingDataStandard プロジェクトの概要
========================================================================

この SettingDataStandard DLL は、AppWizard により作成されました。

このファイルには、SettingDataStandard アプリケーションを構成する各ファイルの内容の概要が含まれています。


SettingDataStandard.vcxproj
...
SettingDataStandard.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、SettingDataStandard.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。
