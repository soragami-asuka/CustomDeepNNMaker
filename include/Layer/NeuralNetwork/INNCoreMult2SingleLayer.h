...
// 複数入力、単一出力を持つNNのレイヤー
//=======================================
#ifndef __GRAVISBELL_I_NN_CORE_MULT_TO_SINGLE_LAYER_H__
#define __GRAVISBELL_I_NN_CORE_MULT_TO_SINGLE_LAYER_H__
...
namespace NeuralNetwork {
	...
	/** レイヤーベース */
	class INNCoreMult2SingleLayer : public virtual IO::IMultInputLayer, public virtual IO::ISingleOutputLayer
	{
	public:
		/** コンストラクタ */
		INNCoreMult2SingleLayer() : IMultInputLayer(), ISingleOutputLayer(){}
		/** デストラクタ */
		virtual ~INNCoreMult2SingleLayer(){}
