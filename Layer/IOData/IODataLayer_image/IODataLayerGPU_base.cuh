...
namespace IOData {
	...
	class IODataLayerGPU_base : public IIODataLayer_image
	{
	protected:
		...
		thrust::device_vector<U08> lpTmpImageBuffer;	/**< 画像バッファを保存する一時バッファ<幅*高さ*ch * バッチサイズ> */
	...
	public:
		...
		virtual Gravisbell::ErrorCode SetData(U32 i_dataNum, const BYTE lpData[], U32 i_lineSize) = 0;
		...
		/** データを番号指定で取得する.
			...
			@return 成功した場合0 */
		virtual Gravisbell::ErrorCode GetDataByNum(U32 num, BYTE o_lpBufferList[])const = 0;
