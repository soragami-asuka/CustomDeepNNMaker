========================================================================
    ダイナミック リンク ライブラリ: IODataLayer_image プロジェクトの概要
========================================================================

この IODataLayer_image DLL は、AppWizard により作成されました。

このファイルには、IODataLayer_image アプリケーションを構成する各ファイルの内容の概要が含まれています。


IODataLayer_image.vcxproj
...
IODataLayer_image.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、IODataLayer_image.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。
