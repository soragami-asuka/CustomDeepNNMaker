========================================================================
    ダイナミック リンク ライブラリ: IODataSequentialLayer プロジェクトの概要
========================================================================

この IODataSequentialLayer DLL は、AppWizard により作成されました。

このファイルには、IODataSequentialLayer アプリケーションを構成する各ファイルの内容の概要が含まれています。


IODataSequentialLayer.vcxproj
...
IODataSequentialLayer.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、IODataSequentialLayer.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。
