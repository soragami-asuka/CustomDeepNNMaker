...
namespace IOData {
	...
	class IODataSequentialLayerGPU_base : public IIODataSequentialLayer
	{
	protected:
	...
	public:
		/** コンストラクタ */
		IODataSequentialLayerGPU_base(Gravisbell::GUID guid, Gravisbell::IODataStruct ioDataStruct);
		/** デストラクタ */
		virtual ~IODataSequentialLayerGPU_base();
	...
	public:
		...
		virtual Gravisbell::ErrorCode SetData(U32 i_dataNo, const F32 lpData[]) = 0;
