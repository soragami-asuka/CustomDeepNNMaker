...
namespace NeuralNetwork {
	...
	public:
		/** コンストラクタ */
		Pooling_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~Pooling_LayerData_Base();
