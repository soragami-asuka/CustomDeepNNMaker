...
namespace NeuralNetwork {
	...
	class Reshape_SquaresCenterCross_LayerData_Base : public ILayerData
	{
	protected:
		Gravisbell::GUID guid;	/**< レイヤーデータ識別用のGUID */

		SettingData::Standard::IData* pLayerStructure;	/**< レイヤー構造を定義したコンフィグクラス */
		Reshape_SquaresCenterCross::LayerStructure layerStructure;	/**< レイヤー構造 */
	...
	public:
		/** コンストラクタ */
		Reshape_SquaresCenterCross_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~Reshape_SquaresCenterCross_LayerData_Base();
