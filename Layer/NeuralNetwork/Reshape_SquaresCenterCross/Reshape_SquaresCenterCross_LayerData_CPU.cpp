...
namespace NeuralNetwork {
	...
	ILayerBase* Reshape_SquaresCenterCross_LayerData_CPU::CreateLayer(const Gravisbell::GUID& guid, const IODataStruct i_lpInputDataStruct[], U32 i_inputLayerCount)
	{
