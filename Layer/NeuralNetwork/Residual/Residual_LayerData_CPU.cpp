...
namespace NeuralNetwork {
	...
	ILayerBase* Residual_LayerData_CPU::CreateLayer(const Gravisbell::GUID& guid, const IODataStruct i_lpInputDataStruct[], U32 i_inputLayerCount, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager)
	{
		...
		return new CNNMult2SingleLayerBase_CPU<Residual_CPU,Residual_LayerData_CPU>(guid, *this, lpInputDataStruct, i_temporaryMemoryManager);
	}
