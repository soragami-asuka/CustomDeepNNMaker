...
namespace NeuralNetwork {
	...
	//===========================
	/** コンストラクタ */
	Residual_LayerData_GPU::Residual_LayerData_GPU(const Gravisbell::GUID& guid)
		:	Residual_LayerData_Base(guid)
	{
	}
	/** デストラクタ */
	Residual_LayerData_GPU::~Residual_LayerData_GPU()
	{
	}
	...
	ILayerBase* Residual_LayerData_GPU::CreateLayer(const Gravisbell::GUID& guid, const IODataStruct i_lpInputDataStruct[], U32 i_inputLayerCount, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager)
	{
...
{
	// 作成
	Gravisbell::Layer::NeuralNetwork::Residual_LayerData_GPU* pLayerData = new Gravisbell::Layer::NeuralNetwork::Residual_LayerData_GPU(guid);
	if(pLayerData == NULL)
		return NULL;
