...
public:
	/** コンストラクタ */
	Residual_CPU(Gravisbell::GUID guid, class Residual_LayerData_CPU& i_layerData, const std::vector<IODataStruct>& i_lpInputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
