/*--------------------------------------------
 * FileName  : Residual_DATA.hpp
 * LayerName : 残差レイヤー
 * guid      : 0519E7FA-311D-4A1D-A615-959AFDD00526
 * 
 * Text      : 入力信号のCHを加算して出力する.ResNet用.
--------------------------------------------*/
#ifndef __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_Residual_H__
#define __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_Residual_H__
...
/** Create a layer for CPU processing.
  ...
  */
EXPORT_API Gravisbell::Layer::ILayerData* CreateLayerDataCPU_MultInput(const Gravisbell::Layer::NeuralNetwork::ILayerDLLManager* pLayerDLLManager, Gravisbell::GUID guid, const Gravisbell::SettingData::Standard::IData& i_data, const Gravisbell::IODataStruct i_inputDataStruct[], Gravisbell::U32 i_inputDataCount);
...
/** Create a layer for GPU processing.
  * @param GUID of layer to create.
  */
EXPORT_API Gravisbell::Layer::ILayerData* CreateLayerDataGPU_MultInput(const Gravisbell::Layer::NeuralNetwork::ILayerDLLManager* pLayerDLLManager, Gravisbell::GUID guid, const Gravisbell::SettingData::Standard::IData& i_data, const Gravisbell::IODataStruct i_inputDataStruct[], Gravisbell::U32 i_inputDataCount);
...
#endif // __GRAVISBELL_NEURAULNETWORK_LAYER_FUNC_Residual_H__
