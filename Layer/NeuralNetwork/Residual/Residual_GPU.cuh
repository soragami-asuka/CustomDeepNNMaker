...
public:
	/** コンストラクタ */
	Residual_GPU(Gravisbell::GUID guid, class Residual_LayerData_GPU& i_layerData, const std::vector<IODataStruct>& i_lpInputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
