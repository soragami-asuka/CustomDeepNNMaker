...
namespace NeuralNetwork {
	...
	//===========================
	/** コンストラクタ */
	MergeInput_LayerData_GPU::MergeInput_LayerData_GPU(const Gravisbell::GUID& guid)
		:	MergeInput_LayerData_Base(guid)
	{
	}
	/** デストラクタ */
	MergeInput_LayerData_GPU::~MergeInput_LayerData_GPU()
	{
	}
	...
	ILayerBase* MergeInput_LayerData_GPU::CreateLayer(const Gravisbell::GUID& guid, const IODataStruct i_lpInputDataStruct[], U32 i_inputLayerCount, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager)
	{
		...
		return new CNNMult2SingleLayerBase_GPU<MergeInput_GPU, MergeInput_LayerData_GPU>(guid, *this, lpInputDataStruct, i_temporaryMemoryManager);
	}
