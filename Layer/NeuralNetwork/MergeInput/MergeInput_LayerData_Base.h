...
// プーリングレイヤーのデータ
//======================================
#ifndef __MergeInput_DATA_BASE_H__
#define __MergeInput_DATA_BASE_H__

#include<Layer/IO/IMultInputLayerData.h>
...
namespace NeuralNetwork {
	...
	class MergeInput_LayerData_Base : public IO::IMultInputLayerData, public IO::ISingleOutputLayerData
	{
	protected:
		...
		MergeInput::LayerStructure layerStructure;	/**< レイヤー構造 */
	...
	public:
		/** コンストラクタ */
		MergeInput_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~MergeInput_LayerData_Base();
	...
	public:
		...
		/** 初期化. 各ニューロンの値をランダムに初期化
			...
			@return	成功した場合0 */
		ErrorCode Initialize(const SettingData::Standard::IData& i_data, const IODataStruct i_lpInputDataStruct[], U32 i_inputDataCount);
		/** 初期化. バッファからデータを読み込む
