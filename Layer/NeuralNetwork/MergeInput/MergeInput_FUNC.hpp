 ...
 * Text      : 入力信号を結合して出力する
--------------------------------------------*/
#ifndef __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_MergeInput_H__
#define __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_MergeInput_H__
...
#endif // __GRAVISBELL_NEURAULNETWORK_LAYER_FUNC_MergeInput_H__
