...
// GPU処理用
//======================================
#ifndef __MergeInput_GPU_H__
#define __MergeInput_GPU_H__
...
class MergeInput_GPU : public MergeInput_Base
{
private:
	// データ本体
	class MergeInput_LayerData_GPU& layerData;
...
public:
	/** コンストラクタ */
	MergeInput_GPU(Gravisbell::GUID guid, class MergeInput_LayerData_GPU& i_layerData, const std::vector<IODataStruct>& i_lpInputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
