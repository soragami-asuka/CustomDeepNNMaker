...
// 活性関数のレイヤーデータ
//======================================
#ifndef __Dropout_DATA_BASE_H__
#define __Dropout_DATA_BASE_H__
...
namespace NeuralNetwork {
	...
	class Dropout_LayerData_Base : public IO::ISingleInputLayerData, public IO::ISingleOutputLayerData
	{
	protected:
		...
		Dropout::LayerStructure layerStructure;	/**< レイヤー構造 */
	...
	public:
		/** コンストラクタ */
		Dropout_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~Dropout_LayerData_Base();
