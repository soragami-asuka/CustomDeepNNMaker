...
namespace NeuralNetwork {
	...
	class Dropout_Base : public Gravisbell::Layer::NeuralNetwork::INNLayer
	{
	protected:
	...
	public:
		/** レイヤーデータを取得する */
		virtual Dropout_LayerData_Base& GetLayerData() = 0;
		virtual const Dropout_LayerData_Base& GetLayerData()const = 0;
	};
