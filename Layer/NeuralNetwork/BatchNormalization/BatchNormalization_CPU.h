...
public:
	/** コンストラクタ */
	BatchNormalization_CPU(Gravisbell::GUID guid, class BatchNormalization_LayerData_CPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
