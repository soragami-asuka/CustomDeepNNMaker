...
--------------------------------------------*/
#ifndef __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_MergeAdd_H__
#define __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_MergeAdd_H__
...
#endif // __GRAVISBELL_NEURAULNETWORK_LAYER_FUNC_MergeAdd_H__
