...
// CPU処理用
//======================================
#ifndef __MergeAdd_CPU_H__
#define __MergeAdd_CPU_H__
...
class MergeAdd_CPU : public MergeAdd_Base
{
private:
	// データ本体
	class MergeAdd_LayerData_CPU& layerData;
...
public:
	/** コンストラクタ */
	MergeAdd_CPU(Gravisbell::GUID guid, class MergeAdd_LayerData_CPU& i_layerData, const std::vector<IODataStruct>& i_lpInputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~MergeAdd_CPU();
