...
// プーリングレイヤーのデータ
//======================================
#ifndef __MergeAdd_DATA_BASE_H__
#define __MergeAdd_DATA_BASE_H__
...
namespace NeuralNetwork {
	...
	public:
		/** コンストラクタ */
		MergeAdd_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~MergeAdd_LayerData_Base();
