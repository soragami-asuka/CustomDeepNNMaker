...
// 出力信号分割レイヤーのデータ
//======================================
#ifndef __Value2SignalArray_DATA_BASE_H__
#define __Value2SignalArray_DATA_BASE_H__
...
namespace NeuralNetwork {
	...
	class Value2SignalArray_LayerData_Base : public ILayerData
	{
	protected:
		Gravisbell::GUID guid;	/**< レイヤーデータ識別用のGUID */

		SettingData::Standard::IData* pLayerStructure;	/**< レイヤー構造を定義したコンフィグクラス */
		Value2SignalArray::LayerStructure layerStructure;	/**< レイヤー構造 */
	...
	public:
		/** コンストラクタ */
		Value2SignalArray_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~Value2SignalArray_LayerData_Base();
