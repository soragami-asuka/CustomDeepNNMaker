...
// GPU処理用
//======================================
#ifndef __Value2SignalArray_GPU_H__
#define __Value2SignalArray_GPU_H__
...
class Value2SignalArray_GPU : public Value2SignalArray_Base
{
private:
	// データ本体
	class Value2SignalArray_LayerData_GPU& layerData;
	...
	thrust::device_vector<F32> lpSignal2ValueWeight_d;	/**< Signal -> value変換を行うための重み配列 */
...
public:
	/** コンストラクタ */
	Value2SignalArray_GPU(Gravisbell::GUID guid, class Value2SignalArray_LayerData_GPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~Value2SignalArray_GPU();
...
public:
	...
	//===========================
	/** レイヤーデータを取得する */
	Value2SignalArray_LayerData_Base& GetLayerData();
	const Value2SignalArray_LayerData_Base& GetLayerData()const;
