...
// プーリングレイヤーのデータ
//======================================
#ifndef __MergeMultiply_DATA_BASE_H__
#define __MergeMultiply_DATA_BASE_H__
...
namespace NeuralNetwork {
	...
	class MergeMultiply_LayerData_Base : public ILayerData
	{
	protected:
		Gravisbell::GUID guid;	/**< レイヤーデータ識別用のGUID */

		SettingData::Standard::IData* pLayerStructure;	/**< レイヤー構造を定義したコンフィグクラス */
		MergeMultiply::LayerStructure layerStructure;	/**< レイヤー構造 */
	...
	public:
		/** コンストラクタ */
		MergeMultiply_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~MergeMultiply_LayerData_Base();
