...
namespace NeuralNetwork {
	...
	//===========================
	/** コンストラクタ */
	MergeMultiply_LayerData_CPU::MergeMultiply_LayerData_CPU(const Gravisbell::GUID& guid)
		:	MergeMultiply_LayerData_Base(guid)
	{
	}
	/** デストラクタ */
	MergeMultiply_LayerData_CPU::~MergeMultiply_LayerData_CPU()
	{
	}
	...
	ILayerBase* MergeMultiply_LayerData_CPU::CreateLayer(const Gravisbell::GUID& guid, const IODataStruct i_lpInputDataStruct[], U32 i_inputLayerCount, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager)
	{
		...
		return new CNNMult2SingleLayerBase_CPU<MergeMultiply_CPU,MergeMultiply_LayerData_CPU>(guid, *this, lpInputDataStruct, i_temporaryMemoryManager);
	}
...
{
	// 作成
	Gravisbell::Layer::NeuralNetwork::MergeMultiply_LayerData_CPU* pLayerData = new Gravisbell::Layer::NeuralNetwork::MergeMultiply_LayerData_CPU(guid);
	if(pLayerData == NULL)
		return NULL;
