...
namespace NeuralNetwork {
	...
	//===========================
	/** コンストラクタ */
	MergeMultiply_LayerData_GPU::MergeMultiply_LayerData_GPU(const Gravisbell::GUID& guid)
		:	MergeMultiply_LayerData_Base(guid)
	{
	}
	/** デストラクタ */
	MergeMultiply_LayerData_GPU::~MergeMultiply_LayerData_GPU()
	{
	}
	...
	ILayerBase* MergeMultiply_LayerData_GPU::CreateLayer(const Gravisbell::GUID& guid, const IODataStruct i_lpInputDataStruct[], U32 i_inputLayerCount, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager)
	{
		...
		return new CNNMult2SingleLayerBase_GPU<MergeMultiply_GPU,MergeMultiply_LayerData_GPU>(guid, *this, lpInputDataStruct, i_temporaryMemoryManager);
	}
...
{
	// 作成
	Gravisbell::Layer::NeuralNetwork::MergeMultiply_LayerData_GPU* pLayerData = new Gravisbell::Layer::NeuralNetwork::MergeMultiply_LayerData_GPU(guid);
	if(pLayerData == NULL)
		return NULL;
