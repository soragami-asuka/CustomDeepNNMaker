...
// CPU処理用
//======================================
#ifndef __MergeMultiply_CPU_H__
#define __MergeMultiply_CPU_H__
...
class MergeMultiply_CPU : public MergeMultiply_Base
{
private:
	// データ本体
	class MergeMultiply_LayerData_CPU& layerData;
...
public:
	/** コンストラクタ */
	MergeMultiply_CPU(Gravisbell::GUID guid, class MergeMultiply_LayerData_CPU& i_layerData, const std::vector<IODataStruct>& i_lpInputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~MergeMultiply_CPU();
