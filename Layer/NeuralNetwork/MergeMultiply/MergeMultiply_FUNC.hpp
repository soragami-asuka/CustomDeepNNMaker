...
--------------------------------------------*/
#ifndef __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_MergeMultiply_H__
#define __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_MergeMultiply_H__
...
#endif // __GRAVISBELL_NEURAULNETWORK_LAYER_FUNC_MergeMultiply_H__
