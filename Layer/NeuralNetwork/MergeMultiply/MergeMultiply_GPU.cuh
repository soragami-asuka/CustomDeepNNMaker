...
// GPU処理用
//======================================
#ifndef __MergeMultiply_GPU_H__
#define __MergeMultiply_GPU_H__
...
class MergeMultiply_GPU : public MergeMultiply_Base
{
private:
	// データ本体
	class MergeMultiply_LayerData_GPU& layerData;
...
public:
	/** コンストラクタ */
	MergeMultiply_GPU(Gravisbell::GUID guid, class MergeMultiply_LayerData_GPU& i_layerData, const std::vector<IODataStruct>& i_lpInputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~MergeMultiply_GPU();
...
public:
	...
	//===========================
	/** レイヤーデータを取得する */
	MergeMultiply_LayerData_Base& GetLayerData();
	const MergeMultiply_LayerData_Base& GetLayerData()const;
