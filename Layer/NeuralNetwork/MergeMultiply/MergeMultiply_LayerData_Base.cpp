...
namespace NeuralNetwork {
	...
	/** 初期化. バッファからデータを読み込む
		...
		@return	成功した場合0 */
	ErrorCode MergeMultiply_LayerData_Base::InitializeFromBuffer(const BYTE* i_lpBuffer, U32 i_bufferSize, S32& o_useBufferSize)
	{
	...
	U32 MergeMultiply_LayerData_Base::GetUseBufferByteCount()const
	{
		U32 bufferSize = 0;
	...
	S32 MergeMultiply_LayerData_Base::WriteToBuffer(BYTE* o_lpBuffer)const
	{
		if(this->pLayerStructure == NULL)
