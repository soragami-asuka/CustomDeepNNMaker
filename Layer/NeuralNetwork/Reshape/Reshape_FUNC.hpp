 ...
 * Text      : 入力信号構造を変換する.
--------------------------------------------*/
#ifndef __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_Reshape_H__
#define __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_Reshape_H__
...
#endif // __GRAVISBELL_NEURAULNETWORK_LAYER_FUNC_Reshape_H__
