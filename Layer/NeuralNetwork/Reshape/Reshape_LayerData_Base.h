...
// 出力信号分割レイヤーのデータ
//======================================
#ifndef __RESHAPE_DATA_BASE_H__
#define __RESHAPE_DATA_BASE_H__
...
namespace NeuralNetwork {
	...
	public:
		/** コンストラクタ */
		Reshape_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~Reshape_LayerData_Base();
