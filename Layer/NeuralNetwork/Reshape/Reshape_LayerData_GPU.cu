...
namespace NeuralNetwork {
	...
	//===========================
	/** コンストラクタ */
	Reshape_LayerData_GPU::Reshape_LayerData_GPU(const Gravisbell::GUID& guid)
		:	Reshape_LayerData_Base(guid)
	{
	}
	/** デストラクタ */
	Reshape_LayerData_GPU::~Reshape_LayerData_GPU()
	{
	}
	...
	ILayerBase* Reshape_LayerData_GPU::CreateLayer(const Gravisbell::GUID& guid, const IODataStruct i_lpInputDataStruct[], U32 i_inputLayerCount, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager)
	{
		if(this->CheckCanUseInputDataStruct(i_lpInputDataStruct, i_inputLayerCount) == false)
			return NULL;

		return new CNNSingle2SingleLayerBase_GPU<Reshape_GPU,Reshape_LayerData_GPU>(guid, *this, i_lpInputDataStruct[0], i_temporaryMemoryManager);
	}
...
{
	// 作成
	Gravisbell::Layer::NeuralNetwork::Reshape_LayerData_GPU* pLayerData = new Gravisbell::Layer::NeuralNetwork::Reshape_LayerData_GPU(guid);
	if(pLayerData == NULL)
		return NULL;
