...
// CPU処理用
//======================================
#ifndef __RESHAPE_CPU_H__
#define __RESHAPE_CPU_H__
...
class Reshape_CPU : public Reshape_Base
{
private:
	// データ本体
	class Reshape_LayerData_CPU& layerData;

	// 入出力バッファ

public:
	/** コンストラクタ */
	Reshape_CPU(Gravisbell::GUID guid, class Reshape_LayerData_CPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~Reshape_CPU();
