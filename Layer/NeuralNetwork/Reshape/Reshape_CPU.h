...
private:
	...
	CONST_BATCH_BUFFER_POINTER m_lpDInputBuffer;	/**< 演算時の出力誤差データ */

public:
	/** コンストラクタ */
	Reshape_CPU(Gravisbell::GUID guid, class Reshape_LayerData_CPU& i_layerData, const IODataStruct& i_inputDataStruct);
	/** デストラクタ */
	virtual ~Reshape_CPU();
