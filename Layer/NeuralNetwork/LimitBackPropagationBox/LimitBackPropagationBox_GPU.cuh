...
// GPU処理用
//======================================
#ifndef __LimitBackPropagationBox_GPU_H__
#define __LimitBackPropagationBox_GPU_H__
...
class LimitBackPropagationBox_GPU : public LimitBackPropagationBox_Base
{
private:
	// データ本体
	class LimitBackPropagationBox_LayerData_GPU& layerData;
...
public:
	/** コンストラクタ */
	LimitBackPropagationBox_GPU(Gravisbell::GUID guid, class LimitBackPropagationBox_LayerData_GPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~LimitBackPropagationBox_GPU();
