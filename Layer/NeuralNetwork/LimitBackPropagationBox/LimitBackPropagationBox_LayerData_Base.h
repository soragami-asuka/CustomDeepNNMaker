...
// 出力信号分割レイヤーのデータ
//======================================
#ifndef __LimitBackPropagationBox_DATA_BASE_H__
#define __LimitBackPropagationBox_DATA_BASE_H__
...
namespace NeuralNetwork {
	...
	class LimitBackPropagationBox_LayerData_Base : public ILayerData
	{
	protected:
		Gravisbell::GUID guid;	/**< レイヤーデータ識別用のGUID */

		SettingData::Standard::IData* pLayerStructure;	/**< レイヤー構造を定義したコンフィグクラス */
		LimitBackPropagationBox::LayerStructure layerStructure;	/**< レイヤー構造 */
	...
	public:
		/** コンストラクタ */
		LimitBackPropagationBox_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~LimitBackPropagationBox_LayerData_Base();
