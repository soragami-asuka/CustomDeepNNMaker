...
// CPU処理用
//======================================
#ifndef __SignalArray2Value_CPU_H__
#define __SignalArray2Value_CPU_H__
...
class SignalArray2Value_CPU : public SignalArray2Value_Base
{
private:
	// データ本体
	class SignalArray2Value_LayerData_CPU& layerData;
...
public:
	/** コンストラクタ */
	SignalArray2Value_CPU(Gravisbell::GUID guid, class SignalArray2Value_LayerData_CPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~SignalArray2Value_CPU();
