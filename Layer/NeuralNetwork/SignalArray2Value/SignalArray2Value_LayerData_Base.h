...
// 出力信号分割レイヤーのデータ
//======================================
#ifndef __SignalArray2Value_DATA_BASE_H__
#define __SignalArray2Value_DATA_BASE_H__
...
namespace NeuralNetwork {
	...
	class SignalArray2Value_LayerData_Base : public ILayerData
	{
	protected:
		Gravisbell::GUID guid;	/**< レイヤーデータ識別用のGUID */

		SettingData::Standard::IData* pLayerStructure;	/**< レイヤー構造を定義したコンフィグクラス */
		SignalArray2Value::LayerStructure layerStructure;	/**< レイヤー構造 */
	...
	public:
		/** コンストラクタ */
		SignalArray2Value_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~SignalArray2Value_LayerData_Base();
