...
// レイヤー間の接続設定用クラス
//======================================
#ifndef __GRAVISBELL_LAYER_CONNECT_MULT2SINGLE_H__
#define __GRAVISBELL_LAYER_CONNECT_MULT2SINGLE_H__
...
namespace NeuralNetwork {
	...
	class LayerConnectMult2Single : public ILayerConnect
	{
	public:
		...
		std::vector<CONST_BATCH_BUFFER_POINTER> lppInputBuffer;	/**< 入力バッファ格納用の配列 */

		S32 outputBufferID;					/**< 出力バッファID */
		std::vector<S32> lpDInputBufferID;	/**< 入力誤差バッファID */
		std::vector<BATCH_BUFFER_POINTER> lppDInputBuffer;	/**< 入力誤差バッファ格納用の配列 */
	...
	public:
		/** コンストラクタ */
		LayerConnectMult2Single(class FeedforwardNeuralNetwork_Base& neuralNetwork, ILayerBase* pLayer, bool onFixFlag);
		/** デストラクタ */
...
#endif	// __GRAVISBELL_LAYER_CONNECT_SINGLE2SINGLE_H__