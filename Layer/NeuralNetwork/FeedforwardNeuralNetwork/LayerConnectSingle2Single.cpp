...
namespace NeuralNetwork {
	...
	/** コンストラクタ */
	LayerConnectSingle2Single::LayerConnectSingle2Single(class FeedforwardNeuralNetwork_Base& neuralNetwork, ILayerBase* pLayer, bool onFixFlag)
	...
	//====================================
	/** 実行時設定を取得する. */
	const SettingData::Standard::IData* LayerConnectSingle2Single::GetRuntimeParameter()const
	{
	...
	/** 実行時設定を設定する.
		...
		@param	i_param		設定する値. */
	ErrorCode LayerConnectSingle2Single::SetRuntimeParameter(const wchar_t* i_dataID, S32 i_param)
	{
	...
	/** 実行時設定を設定する.
		...
		@param	i_dataID	設定する値のID.
		@param	i_param		設定する値. */
	ErrorCode LayerConnectSingle2Single::SetRuntimeParameter(const wchar_t* i_dataID, F32 i_param)
	{
		return this->pLayer->SetRuntimeParameter(i_dataID, i_param);
	}
	/** 実行時設定を設定する.
		...
		@param	i_dataID	設定する値のID.
		@param	i_param		設定する値. */
	ErrorCode LayerConnectSingle2Single::SetRuntimeParameter(const wchar_t* i_dataID, bool i_param)
	{
		return this->pLayer->SetRuntimeParameter(i_dataID, i_param);
	}
	/** 実行時設定を設定する.
		...
		@param	i_dataID	設定する値のID.
		@param	i_param		設定する値. */
	ErrorCode LayerConnectSingle2Single::SetRuntimeParameter(const wchar_t* i_dataID, const wchar_t* i_param)
	{
		return this->pLayer->SetRuntimeParameter(i_dataID, i_param);
	}
	...
	CONST_BATCH_BUFFER_POINTER LayerConnectSingle2Single::GetOutputBuffer_d()const
	{
	...
	ErrorCode LayerConnectSingle2Single::SetOutputBufferID(S32 i_outputBufferID)
	{
