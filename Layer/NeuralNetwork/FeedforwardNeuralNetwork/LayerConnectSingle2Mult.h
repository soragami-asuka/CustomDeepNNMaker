...
// レイヤー間の接続設定用クラス
//======================================
#ifndef __GRAVISBELL_LAYER_CONNECT_SINGLE2MULT_H__
...
namespace NeuralNetwork {
	...
	public:
		...
		std::vector<LayerPosition>  lppOutputToLayer;		/**< 出力先レイヤー. */
		std::vector<ILayerConnect*> lppInputFromLayer;	/**< 入力元レイヤー. */
	...
	public:
		/** コンストラクタ */
		LayerConnectSingle2Mult(class FeedforwardNeuralNetwork_Base& neuralNetwork, ILayerBase* pLayer, Gravisbell::SettingData::Standard::IData* pRuntimeParameter);
		/** デストラクタ */
