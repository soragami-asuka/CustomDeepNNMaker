 ...
 * LayerName : äàê´âªä÷êî
 * guid      : 99904134-83B7-4502-A0CA-728A2C9D80C7
 * 
 * Text      : äàê´âªä÷êî
--------------------------------------------*/
#ifndef __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_Activation_H__
#define __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_Activation_H__
...
#endif // __GRAVISBELL_NEURAULNETWORK_LAYER_FUNC_Activation_H__
