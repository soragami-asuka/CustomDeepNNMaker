...
class Activation_GPU : public Activation_Base
{
private:
	// データ本体
	class Activation_LayerData_GPU& layerData;
...
public:
	/** コンストラクタ */
	Activation_GPU(Gravisbell::GUID guid, class Activation_LayerData_GPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
