...
--------------------------------------------*/
#ifndef __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_Normalization_Scale_H__
#define __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_Normalization_Scale_H__
...
#endif // __GRAVISBELL_NEURAULNETWORK_LAYER_FUNC_Normalization_Scale_H__
