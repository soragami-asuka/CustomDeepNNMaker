...
// バッチ正規化のレイヤーデータ
//======================================
#ifndef __Normalization_Scale_DATA_BASE_H__
#define __Normalization_Scale_DATA_BASE_H__
...
namespace NeuralNetwork {
	...
	class Normalization_Scale_LayerData_Base : public ILayerData
	{
	protected:
		Gravisbell::GUID guid;	/**< レイヤーデータ識別用のGUID */

		SettingData::Standard::IData* pLayerStructure;	/**< レイヤー構造を定義したコンフィグクラス */
		Normalization_Scale::LayerStructure layerStructure;	/**< レイヤー構造 */
	...
	public:
		/** コンストラクタ */
		Normalization_Scale_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~Normalization_Scale_LayerData_Base();
