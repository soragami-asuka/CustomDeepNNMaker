...
// CPU処理用
//======================================
#ifndef __Normalization_Scale_CPU_H__
#define __Normalization_Scale_CPU_H__
...
class Normalization_Scale_CPU : public Normalization_Scale_Base
{
private:
	// データ本体
	class Normalization_Scale_LayerData_CPU& layerData;
...
public:
	/** コンストラクタ */
	Normalization_Scale_CPU(Gravisbell::GUID guid, class Normalization_Scale_LayerData_CPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~Normalization_Scale_CPU();
