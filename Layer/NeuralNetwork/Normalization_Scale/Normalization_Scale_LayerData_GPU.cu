...
namespace NeuralNetwork {
	...
	/** 初期化. バッファからデータを読み込む
		...
		@return	成功した場合0 */
	ErrorCode Normalization_Scale_LayerData_GPU::InitializeFromBuffer(const BYTE* i_lpBuffer, U64 i_bufferSize, S64& o_useBufferSize )
	{
	...
	S64 Normalization_Scale_LayerData_GPU::WriteToBuffer(BYTE* o_lpBuffer)const
	{
