...
// 出力信号分割レイヤーのデータ
//======================================
#ifndef __ProbabilityArray2Value_DATA_BASE_H__
#define __ProbabilityArray2Value_DATA_BASE_H__
...
namespace NeuralNetwork {
	...
	class ProbabilityArray2Value_LayerData_Base : public ILayerData
	{
	protected:
		Gravisbell::GUID guid;	/**< レイヤーデータ識別用のGUID */

		SettingData::Standard::IData* pLayerStructure;	/**< レイヤー構造を定義したコンフィグクラス */
		ProbabilityArray2Value::LayerStructure layerStructure;	/**< レイヤー構造 */
	...
	public:
		/** コンストラクタ */
		ProbabilityArray2Value_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~ProbabilityArray2Value_LayerData_Base();
