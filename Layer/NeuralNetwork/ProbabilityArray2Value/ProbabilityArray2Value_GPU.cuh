...
// GPU処理用
//======================================
#ifndef __ProbabilityArray2Value_GPU_H__
#define __ProbabilityArray2Value_GPU_H__
...
class ProbabilityArray2Value_GPU : public ProbabilityArray2Value_Base
{
private:
	// データ本体
	class ProbabilityArray2Value_LayerData_GPU& layerData;
...
public:
	/** コンストラクタ */
	ProbabilityArray2Value_GPU(Gravisbell::GUID guid, class ProbabilityArray2Value_LayerData_GPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~ProbabilityArray2Value_GPU();
