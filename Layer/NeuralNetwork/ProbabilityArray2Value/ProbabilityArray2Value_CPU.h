...
// CPU処理用
//======================================
#ifndef __ProbabilityArray2Value_CPU_H__
#define __ProbabilityArray2Value_CPU_H__
...
class ProbabilityArray2Value_CPU : public ProbabilityArray2Value_Base
{
private:
	// データ本体
	class ProbabilityArray2Value_LayerData_CPU& layerData;
	...
	// 一時計算バッファ
	std::vector<F32> lpTmpBuffer;

public:
	/** コンストラクタ */
	ProbabilityArray2Value_CPU(Gravisbell::GUID guid, class ProbabilityArray2Value_LayerData_CPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~ProbabilityArray2Value_CPU();
...
public:
	...
	//===========================
	/** レイヤーデータを取得する */
	ProbabilityArray2Value_LayerData_Base& GetLayerData();
	const ProbabilityArray2Value_LayerData_Base& GetLayerData()const;
