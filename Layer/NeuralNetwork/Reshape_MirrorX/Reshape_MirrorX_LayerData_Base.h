...
// 出力信号分割レイヤーのデータ
//======================================
#ifndef __RESHAPE_MIRRROX_DATA_BASE_H__
#define __RESHAPE_MIRRROX_DATA_BASE_H__
...
namespace NeuralNetwork {
	...
	class Reshape_MirrorX_LayerData_Base : public ILayerData
	{
	protected:
		Gravisbell::GUID guid;	/**< レイヤーデータ識別用のGUID */

		SettingData::Standard::IData* pLayerStructure;	/**< レイヤー構造を定義したコンフィグクラス */
		Reshape_MirrorX::LayerStructure layerStructure;	/**< レイヤー構造 */
	...
	public:
		/** コンストラクタ */
		Reshape_MirrorX_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~Reshape_MirrorX_LayerData_Base();
