...
public:
	/** コンストラクタ */
	Reshape_MirrorX_GPU(Gravisbell::GUID guid, class Reshape_MirrorX_LayerData_GPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
