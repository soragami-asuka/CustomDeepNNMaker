...
// GPU処理用
//======================================
#ifndef __UpConvolution_GPU_H__
#define __UpConvolution_GPU_H__
...
class UpConvolution_GPU : public UpConvolution_Base
{
private:
	// データ本体
	class UpConvolution_LayerData_GPU& layerData;
...
public:
	/** コンストラクタ */
	UpConvolution_GPU(Gravisbell::GUID guid, class UpConvolution_LayerData_GPU& i_layerData);
	/** デストラクタ */
	virtual ~UpConvolution_GPU();
