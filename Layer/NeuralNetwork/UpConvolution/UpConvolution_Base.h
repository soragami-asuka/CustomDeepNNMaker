...
// 結合、活性化を処理する
//======================================
#ifndef __UpConvolution_BASE_H__
#define __UpConvolution_BASE_H__
...
namespace NeuralNetwork {
	...
	class UpConvolution_Base : public INNSingleInputLayer, public INNSingleOutputLayer
	{
	protected:
		Gravisbell::GUID guid;	/**< レイヤー識別用のGUID */

		SettingData::Standard::IData* pLearnData;		/**< 学習設定を定義したコンフィグクラス */
		UpConvolution::LearnDataStructure learnData;	/**< 学習設定 */

		U32 batchSize;	/**< バッチサイズ */

	public:
		/** コンストラクタ */
		UpConvolution_Base(Gravisbell::GUID guid);

		/** デストラクタ */
		virtual ~UpConvolution_Base();
	...
	public:
		/** レイヤーデータを取得する */
		virtual UpConvolution_LayerData_Base& GetLayerData() = 0;
		virtual const UpConvolution_LayerData_Base& GetLayerData()const = 0;
	};
