...
namespace NeuralNetwork {
	...
	/** コンストラクタ */
	UpConvolution_LayerData_Base::UpConvolution_LayerData_Base(const Gravisbell::GUID& guid)
	...
	/** デストラクタ */
	UpConvolution_LayerData_Base::~UpConvolution_LayerData_Base()
	{
	...
	//===========================
	/** レイヤー固有のGUIDを取得する */
	Gravisbell::GUID UpConvolution_LayerData_Base::GetGUID(void)const
	{
		return this->guid;
	}
	...
	/** レイヤー種別識別コードを取得する.
		...
		@return 成功した場合0 */
	Gravisbell::GUID UpConvolution_LayerData_Base::GetLayerCode(void)const
	{
	...
	//===========================
	/** 設定情報を設定 */
	ErrorCode UpConvolution_LayerData_Base::SetLayerConfig(const SettingData::Standard::IData& config)
	{
	...
	/** レイヤーの設定情報を取得する */
	const SettingData::Standard::IData* UpConvolution_LayerData_Base::GetLayerStructure()const
	{
	...
	U32 UpConvolution_LayerData_Base::GetUseBufferByteCount()const
	{
		U32 bufferSize = 0;
	...
	/** 入力データ構造を取得する.
		@return	入力データ構造 */
	IODataStruct UpConvolution_LayerData_Base::GetInputDataStruct()const
	{
		return this->inputDataStruct;
	}

	/** 入力バッファ数を取得する. */
	U32 UpConvolution_LayerData_Base::GetInputBufferCount()const
	{
	...
	//===========================
	/** 出力データ構造を取得する */
	IODataStruct UpConvolution_LayerData_Base::GetOutputDataStruct()const
	{
	...
	/** 出力バッファ数を取得する */
	unsigned int UpConvolution_LayerData_Base::GetOutputBufferCount()const
	{
