...
// 出力信号分割レイヤーのデータ
//======================================
#ifndef __CHOOSECHANNEL_DATA_BASE_H__
#define __CHOOSECHANNEL_DATA_BASE_H__
...
namespace NeuralNetwork {
	...
	class ChooseChannel_LayerData_Base : public ILayerData
	{
	protected:
		Gravisbell::GUID guid;	/**< レイヤーデータ識別用のGUID */

		SettingData::Standard::IData* pLayerStructure;	/**< レイヤー構造を定義したコンフィグクラス */
		ChooseChannel::LayerStructure layerStructure;	/**< レイヤー構造 */
	...
	public:
		/** コンストラクタ */
		ChooseChannel_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~ChooseChannel_LayerData_Base();
