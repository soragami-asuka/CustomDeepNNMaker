...
namespace NeuralNetwork {
	...
	//===========================
	/** コンストラクタ */
	ChooseChannel_LayerData_GPU::ChooseChannel_LayerData_GPU(const Gravisbell::GUID& guid)
		:	ChooseChannel_LayerData_Base(guid)
	{
	}
	/** デストラクタ */
	ChooseChannel_LayerData_GPU::~ChooseChannel_LayerData_GPU()
	{
	}
	...
	ILayerBase* ChooseChannel_LayerData_GPU::CreateLayer(const Gravisbell::GUID& guid, const IODataStruct i_lpInputDataStruct[], U32 i_inputLayerCount, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager)
	{
