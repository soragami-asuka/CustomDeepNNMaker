...
// GPU処理用
//======================================
#ifndef __CHOOSECHANNEL_GPU_H__
#define __CHOOSECHANNEL_GPU_H__
...
class ChooseChannel_GPU : public ChooseChannel_Base
{
private:
	// データ本体
	class ChooseChannel_LayerData_GPU& layerData;
	...
	std::vector<BATCH_BUFFER_POINTER>			lppBatchDInputBuffer;		/**< 入力誤差データ */
	std::vector<BATCH_BUFFER_POINTER>			lppBatchOutputBuffer;		/**< 出力バッファ */
	std::vector<CONST_BATCH_BUFFER_POINTER>		lppBatchDOutputBuffer;	/**< 出力誤差データ */

	cublasHandle_t cublasHandle;

public:
	/** コンストラクタ */
	ChooseChannel_GPU(Gravisbell::GUID guid, class ChooseChannel_LayerData_GPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~ChooseChannel_GPU();
