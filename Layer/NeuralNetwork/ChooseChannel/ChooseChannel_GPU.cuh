...
private:
	...
	// 出力バッファ
	thrust::device_vector<F32> m_lpOutputBuffer;	/**< 出力バッファ */
	std::vector<BATCH_BUFFER_POINTER> m_lppOutputBuffer;	/**< 出力バッファのバッチごとのポインタ */

	cublasHandle_t cublasHandle;

public:
	/** コンストラクタ */
	ChooseChannel_GPU(Gravisbell::GUID guid, class ChooseChannel_LayerData_GPU& i_layerData, const IODataStruct& i_inputDataStruct);
	/** デストラクタ */
