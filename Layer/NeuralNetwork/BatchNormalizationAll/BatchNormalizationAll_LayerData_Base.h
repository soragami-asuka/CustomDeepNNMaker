...
// バッチ正規化のレイヤーデータ
//======================================
#ifndef __BatchNormalizationAll_DATA_BASE_H__
#define __BatchNormalizationAll_DATA_BASE_H__
...
namespace NeuralNetwork {
	...
	class BatchNormalizationAll_LayerData_Base : public ILayerData
	{
	protected:
		Gravisbell::GUID guid;	/**< レイヤーデータ識別用のGUID */

		SettingData::Standard::IData* pLayerStructure;	/**< レイヤー構造を定義したコンフィグクラス */
		BatchNormalizationAll::LayerStructure layerStructure;	/**< レイヤー構造 */
	...
	public:
		/** コンストラクタ */
		BatchNormalizationAll_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~BatchNormalizationAll_LayerData_Base();
