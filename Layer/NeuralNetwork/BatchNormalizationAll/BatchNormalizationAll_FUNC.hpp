...
--------------------------------------------*/
#ifndef __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_BatchNormalizationAll_H__
#define __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_BatchNormalizationAll_H__
...
#endif // __GRAVISBELL_NEURAULNETWORK_LAYER_FUNC_BatchNormalizationAll_H__
