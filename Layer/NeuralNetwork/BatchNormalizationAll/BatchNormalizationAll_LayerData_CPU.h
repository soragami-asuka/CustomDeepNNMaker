...
// バッチ正規化のレイヤーデータ
//======================================
#ifndef __BatchNormalizationAll_LAYERDATA_CPU_H__
#define __BatchNormalizationAll_LAYERDATA_CPU_H__
...
namespace NeuralNetwork {
	...
	class BatchNormalizationAll_LayerData_CPU : public BatchNormalizationAll_LayerData_Base
	{
		friend class BatchNormalizationAll_CPU;
	...
	public:
		/** コンストラクタ */
		BatchNormalizationAll_LayerData_CPU(const Gravisbell::GUID& guid);
		/** デストラクタ */
		~BatchNormalizationAll_LayerData_CPU();
