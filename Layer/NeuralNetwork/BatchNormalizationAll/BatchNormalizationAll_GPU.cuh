...
// GPU処理用
//======================================
#ifndef __BatchNormalizationAll_GPU_H__
#define __BatchNormalizationAll_GPU_H__
...
class BatchNormalizationAll_GPU : public BatchNormalizationAll_Base
{
private:
	// データ本体
	class BatchNormalizationAll_LayerData_GPU& layerData;
...
public:
	/** コンストラクタ */
	BatchNormalizationAll_GPU(Gravisbell::GUID guid, class BatchNormalizationAll_LayerData_GPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~BatchNormalizationAll_GPU();
...
public:
	...
	//===========================
	/** レイヤーデータを取得する */
	BatchNormalizationAll_LayerData_Base& GetLayerData();
	const BatchNormalizationAll_LayerData_Base& GetLayerData()const;
