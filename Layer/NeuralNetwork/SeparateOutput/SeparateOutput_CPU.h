...
// CPU処理用
//======================================
#ifndef __SEPARATEOUTPUT_CPU_H__
#define __SEPARATEOUTPUT_CPU_H__
...
class SeparateOutput_CPU : public SeparateOutput_Base
{
private:
	// データ本体
	class SeparateOutput_LayerData_CPU& layerData;
...
public:
	/** コンストラクタ */
	SeparateOutput_CPU(Gravisbell::GUID guid, class SeparateOutput_LayerData_CPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
