...
namespace NeuralNetwork {
	...
	public:
		/** コンストラクタ */
		SeparateOutput_Base(Gravisbell::GUID guid);
	...
	public:
		/** レイヤーデータを取得する */
		virtual SeparateOutput_LayerData_Base& GetLayerData() = 0;
		virtual const SeparateOutput_LayerData_Base& GetLayerData()const = 0;
	};
