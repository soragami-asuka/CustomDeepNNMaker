/*--------------------------------------------
 * FileName  : SeparateOutput_FUNC.cpp
...
// {C13C30DA-056E-46D0-90FC-608766FB432E}
static const Gravisbell::GUID g_guid(0xc13c30da, 0x056e, 0x46d0, 0x90, 0xfc, 0x60, 0x87, 0x66, 0xfb, 0x43, 0x2e);
...
EXPORT_API Gravisbell::SettingData::Standard::IData* CreateLayerStructureSetting(void)
{
	...
	pLayerConfig->AddItem(
		Gravisbell::SettingData::Standard::CreateItem_Int(
			L"separateCount",
			CurrentLanguage::g_lpItemData_LayerStructure[L"separateCount"].name.c_str(),
			CurrentLanguage::g_lpItemData_LayerStructure[L"separateCount"].text.c_str(),
			1, 65535, 1));
