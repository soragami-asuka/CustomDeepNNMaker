...
// GPU処理用
//======================================
#ifndef __SEPARATEOUTPUT_GPU_H__
#define __SEPARATEOUTPUT_GPU_H__
...
class SeparateOutput_GPU : public SeparateOutput_Base
{
private:
	// データ本体
	class SeparateOutput_LayerData_GPU& layerData;
...
public:
	/** コンストラクタ */
	SeparateOutput_GPU(Gravisbell::GUID guid, class SeparateOutput_LayerData_GPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~SeparateOutput_GPU();
...
public:
	...
	//===========================
	/** レイヤーデータを取得する */
	SeparateOutput_LayerData_Base& GetLayerData();
	const SeparateOutput_LayerData_Base& GetLayerData()const;
