...
public:
	/** コンストラクタ */
	Reshape_SquaresZeroSideLeftTop_CPU(Gravisbell::GUID guid, class Reshape_SquaresZeroSideLeftTop_LayerData_CPU& i_layerData, const IODataStruct& i_inputDataStruct);
	/** デストラクタ */
