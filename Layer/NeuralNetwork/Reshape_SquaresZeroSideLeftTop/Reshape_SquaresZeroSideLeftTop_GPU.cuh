...
public:
	/** コンストラクタ */
	Reshape_SquaresZeroSideLeftTop_GPU(Gravisbell::GUID guid, class Reshape_SquaresZeroSideLeftTop_LayerData_GPU& i_layerData, const IODataStruct& i_inputDataStruct);
	/** デストラクタ */
