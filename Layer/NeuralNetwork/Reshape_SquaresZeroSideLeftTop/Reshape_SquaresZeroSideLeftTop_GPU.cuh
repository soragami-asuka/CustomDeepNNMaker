...
class Reshape_SquaresZeroSideLeftTop_GPU : public Reshape_SquaresZeroSideLeftTop_Base
{
private:
	// データ本体
	class Reshape_SquaresZeroSideLeftTop_LayerData_GPU& layerData;
...
public:
	/** コンストラクタ */
	Reshape_SquaresZeroSideLeftTop_GPU(Gravisbell::GUID guid, class Reshape_SquaresZeroSideLeftTop_LayerData_GPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~Reshape_SquaresZeroSideLeftTop_GPU();
