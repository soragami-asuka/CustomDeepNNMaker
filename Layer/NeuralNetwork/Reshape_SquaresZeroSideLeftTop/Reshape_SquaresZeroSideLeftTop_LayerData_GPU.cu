...
namespace NeuralNetwork {
	...
	ILayerBase* Reshape_SquaresZeroSideLeftTop_LayerData_GPU::CreateLayer(const Gravisbell::GUID& guid, const IODataStruct i_lpInputDataStruct[], U32 i_inputLayerCount)
	{
