...
//======================================
#ifndef __FULLYCONNECT_ACTIVATION_LAYERDATA_CPU_H__
#define __FULLYCONNECT_ACTIVATION_LAYERDATA_CPU_H__
...
namespace NeuralNetwork {
	...
	class FullyConnect_Activation_LayerData_CPU : public FullyConnect_Activation_LayerData_Base
	{
		friend class FullyConnect_Activation_CPU;
	...
	public:
		/** コンストラクタ */
		FullyConnect_Activation_LayerData_CPU(const Gravisbell::GUID& guid);
		/** デストラクタ */
		~FullyConnect_Activation_LayerData_CPU();
