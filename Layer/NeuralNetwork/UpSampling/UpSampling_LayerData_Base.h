...
//======================================
#ifndef __UpSampling_DATA_BASE_H__
#define __UpSampling_DATA_BASE_H__
...
namespace NeuralNetwork {
	...
	class UpSampling_LayerData_Base : public IO::ISingleInputLayerData, public IO::ISingleOutputLayerData
	{
	protected:
		...
		UpSampling::LayerStructure layerStructure;	/**< レイヤー構造 */
	...
	public:
		/** コンストラクタ */
		UpSampling_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~UpSampling_LayerData_Base();
