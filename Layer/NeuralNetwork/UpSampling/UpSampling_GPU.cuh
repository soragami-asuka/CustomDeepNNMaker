...
public:
	/** コンストラクタ */
	UpSampling_GPU(Gravisbell::GUID guid, class UpSampling_LayerData_GPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
