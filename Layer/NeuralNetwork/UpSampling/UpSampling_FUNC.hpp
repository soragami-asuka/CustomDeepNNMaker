 ...
 * Text      : 値を拡張し、穴埋めする
--------------------------------------------*/
#ifndef __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_UpSampling_H__
#define __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_UpSampling_H__
...
#endif // __GRAVISBELL_NEURAULNETWORK_LAYER_FUNC_UpSampling_H__
