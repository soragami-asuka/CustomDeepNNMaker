...
// 活性関数のレイヤーデータ
//======================================
#ifndef __Activation_Discriminator_DATA_BASE_H__
#define __Activation_Discriminator_DATA_BASE_H__
...
namespace NeuralNetwork {
	...
	class Activation_Discriminator_LayerData_Base : public IO::ISingleInputLayerData, public IO::ISingleOutputLayerData
	{
	protected:
...
//		Activation_Discriminator::LayerStructure layerStructure;	/**< レイヤー構造 */
	...
	public:
		/** コンストラクタ */
		Activation_Discriminator_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~Activation_Discriminator_LayerData_Base();
