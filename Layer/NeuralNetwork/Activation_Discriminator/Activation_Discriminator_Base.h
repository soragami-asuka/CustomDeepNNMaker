...
namespace NeuralNetwork {
	...
	class Activation_Discriminator_Base : public INNSingle2SingleLayer
	{
	protected:
	...
	public:
		/** コンストラクタ */
		Activation_Discriminator_Base(Gravisbell::GUID guid);
	...
	public:
		/** レイヤーデータを取得する */
		virtual Activation_Discriminator_LayerData_Base& GetLayerData() = 0;
		virtual const Activation_Discriminator_LayerData_Base& GetLayerData()const = 0;
	};
