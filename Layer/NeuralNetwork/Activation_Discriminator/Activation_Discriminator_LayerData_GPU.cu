...
namespace NeuralNetwork {
	...
	//===========================
	/** コンストラクタ */
	Activation_Discriminator_LayerData_GPU::Activation_Discriminator_LayerData_GPU(const Gravisbell::GUID& guid)
		:	Activation_Discriminator_LayerData_Base(guid)
	{
	}
	/** デストラクタ */
	Activation_Discriminator_LayerData_GPU::~Activation_Discriminator_LayerData_GPU()
	{
	}
	...
	ILayerBase* Activation_Discriminator_LayerData_GPU::CreateLayer(const Gravisbell::GUID& guid, const IODataStruct i_lpInputDataStruct[], U32 i_inputLayerCount, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager)
	{
...
{
	// 作成
	Gravisbell::Layer::NeuralNetwork::Activation_Discriminator_LayerData_GPU* pLayerData = new Gravisbell::Layer::NeuralNetwork::Activation_Discriminator_LayerData_GPU(guid);
	if(pLayerData == NULL)
		return NULL;
