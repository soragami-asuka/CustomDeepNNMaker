 ...
 * Text      : 自己組織化マップ.
--------------------------------------------*/
#ifndef __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_SOM_H__
#define __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_SOM_H__
...
#endif // __GRAVISBELL_NEURAULNETWORK_LAYER_FUNC_SOM_H__
