...
namespace NeuralNetwork {
	...
	/** 初期化. バッファからデータを読み込む
		...
		@return	成功した場合0 */
	ErrorCode SOM_LayerData_CPU::InitializeFromBuffer(const BYTE* i_lpBuffer, U32 i_bufferSize, S32& o_useBufferSize)
	{
	...
	S32 SOM_LayerData_CPU::WriteToBuffer(BYTE* o_lpBuffer)const
	{
