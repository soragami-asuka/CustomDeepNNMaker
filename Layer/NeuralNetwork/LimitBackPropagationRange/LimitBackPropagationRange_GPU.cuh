...
// GPU処理用
//======================================
#ifndef __LimitBackPropagationRange_GPU_H__
#define __LimitBackPropagationRange_GPU_H__
...
class LimitBackPropagationRange_GPU : public LimitBackPropagationRange_Base
{
private:
	// データ本体
	class LimitBackPropagationRange_LayerData_GPU& layerData;
...
public:
	/** コンストラクタ */
	LimitBackPropagationRange_GPU(Gravisbell::GUID guid, class LimitBackPropagationRange_LayerData_GPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~LimitBackPropagationRange_GPU();
