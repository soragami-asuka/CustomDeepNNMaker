 ...
 * LayerName : å„ï˚ì`î¿Ç∑ÇÈîÕàÕÇêßå¿Ç∑ÇÈ
 * guid      : 89359466-E1B2-4129-90E8-50C74E4BC597
 * 
 * Text      : å„ï˚ì`î¿Ç∑ÇÈîÕàÕÇêßå¿Ç∑ÇÈ.
--------------------------------------------*/
#ifndef __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_LimitBackPropagationRange_H__
#define __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_LimitBackPropagationRange_H__
...
#endif // __GRAVISBELL_NEURAULNETWORK_LAYER_FUNC_LimitBackPropagationRange_H__
