...
// 出力信号分割レイヤーのデータ
//======================================
#ifndef __LimitBackPropagationRange_DATA_BASE_H__
#define __LimitBackPropagationRange_DATA_BASE_H__
...
namespace NeuralNetwork {
	...
	class LimitBackPropagationRange_LayerData_Base : public ILayerData
	{
	protected:
		Gravisbell::GUID guid;	/**< レイヤーデータ識別用のGUID */

		SettingData::Standard::IData* pLayerStructure;	/**< レイヤー構造を定義したコンフィグクラス */
		LimitBackPropagationRange::LayerStructure layerStructure;	/**< レイヤー構造 */
	...
	public:
		/** コンストラクタ */
		LimitBackPropagationRange_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~LimitBackPropagationRange_LayerData_Base();
