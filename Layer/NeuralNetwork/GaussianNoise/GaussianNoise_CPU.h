...
// CPU処理用
//======================================
#ifndef __GAUSSIANNOISE_CPU_H__
#define __GAUSSIANNOISE_CPU_H__
...
class GaussianNoise_CPU : public GaussianNoise_Base
{
private:
	// データ本体
	class GaussianNoise_LayerData_CPU& layerData;
...
public:
	/** コンストラクタ */
	GaussianNoise_CPU(Gravisbell::GUID guid, class GaussianNoise_LayerData_CPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~GaussianNoise_CPU();
...
public:
	...
	//===========================
	/** レイヤーデータを取得する */
	GaussianNoise_LayerData_Base& GetLayerData();
	const GaussianNoise_LayerData_Base& GetLayerData()const;
