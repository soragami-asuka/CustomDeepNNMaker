...
// プーリングレイヤーのデータ
//======================================
#ifndef __GAUSSIANNOISE_DATA_BASE_H__
#define __GAUSSIANNOISE_DATA_BASE_H__
...
namespace NeuralNetwork {
	...
	class GaussianNoise_LayerData_Base : public ILayerData
	{
	protected:
	...
	public:
		/** コンストラクタ */
		GaussianNoise_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~GaussianNoise_LayerData_Base();
