...
// GPU処理用
//======================================
#ifndef __GAUSSIANNOISE_GPU_H__
#define __GAUSSIANNOISE_GPU_H__
...
class GaussianNoise_GPU : public GaussianNoise_Base
{
private:
	// データ本体
	class GaussianNoise_LayerData_GPU& layerData;
...
public:
	/** コンストラクタ */
	GaussianNoise_GPU(Gravisbell::GUID guid, class GaussianNoise_LayerData_GPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~GaussianNoise_GPU();
