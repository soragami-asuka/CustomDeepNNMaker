...
namespace NeuralNetwork {
	...
	//===========================
	/** コンストラクタ */
	GaussianNoise_LayerData_CPU::GaussianNoise_LayerData_CPU(const Gravisbell::GUID& guid)
		:	GaussianNoise_LayerData_Base(guid)
	{
	}
	/** デストラクタ */
	GaussianNoise_LayerData_CPU::~GaussianNoise_LayerData_CPU()
	{
	}
	...
	ILayerBase* GaussianNoise_LayerData_CPU::CreateLayer(const Gravisbell::GUID& guid, const IODataStruct i_lpInputDataStruct[], U32 i_inputLayerCount, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager)
	{
		if(this->CheckCanUseInputDataStruct(i_lpInputDataStruct, i_inputLayerCount) == false)
			return NULL;

		return new CNNSingle2SingleLayerBase_CPU<GaussianNoise_CPU, GaussianNoise_LayerData_CPU>(guid, *this, i_lpInputDataStruct[0], i_temporaryMemoryManager);
	}
...
{
	// 作成
	Gravisbell::Layer::NeuralNetwork::GaussianNoise_LayerData_CPU* pLayerData = new Gravisbell::Layer::NeuralNetwork::GaussianNoise_LayerData_CPU(guid);
	if(pLayerData == NULL)
		return NULL;
