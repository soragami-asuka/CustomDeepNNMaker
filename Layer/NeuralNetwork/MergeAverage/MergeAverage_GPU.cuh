...
// GPU処理用
//======================================
#ifndef __MergeAverage_GPU_H__
#define __MergeAverage_GPU_H__
...
class MergeAverage_GPU : public MergeAverage_Base
{
private:
	// データ本体
	class MergeAverage_LayerData_GPU& layerData;
...
public:
	/** コンストラクタ */
	MergeAverage_GPU(Gravisbell::GUID guid, class MergeAverage_LayerData_GPU& i_layerData, const std::vector<IODataStruct>& i_lpInputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~MergeAverage_GPU();
...
public:
	...
	//===========================
	/** レイヤーデータを取得する */
	MergeAverage_LayerData_Base& GetLayerData();
	const MergeAverage_LayerData_Base& GetLayerData()const;
