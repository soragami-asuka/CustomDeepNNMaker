...
// プーリングレイヤーのデータ
//======================================
#ifndef __MergeAverage_DATA_BASE_H__
#define __MergeAverage_DATA_BASE_H__
...
namespace NeuralNetwork {
	...
	class MergeAverage_LayerData_Base : public ILayerData
	{
	protected:
		Gravisbell::GUID guid;	/**< レイヤーデータ識別用のGUID */

		SettingData::Standard::IData* pLayerStructure;	/**< レイヤー構造を定義したコンフィグクラス */
		MergeAverage::LayerStructure layerStructure;	/**< レイヤー構造 */
	...
	public:
		/** コンストラクタ */
		MergeAverage_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~MergeAverage_LayerData_Base();
