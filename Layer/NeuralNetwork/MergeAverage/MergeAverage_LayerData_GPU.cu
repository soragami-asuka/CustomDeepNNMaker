...
namespace NeuralNetwork {
	...
	//===========================
	/** コンストラクタ */
	MergeAverage_LayerData_GPU::MergeAverage_LayerData_GPU(const Gravisbell::GUID& guid)
		:	MergeAverage_LayerData_Base(guid)
	{
	}
	/** デストラクタ */
	MergeAverage_LayerData_GPU::~MergeAverage_LayerData_GPU()
	{
	}
	...
	ILayerBase* MergeAverage_LayerData_GPU::CreateLayer(const Gravisbell::GUID& guid, const IODataStruct i_lpInputDataStruct[], U32 i_inputLayerCount, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager)
	{
		...
		return new CNNMult2SingleLayerBase_GPU<MergeAverage_GPU,MergeAverage_LayerData_GPU>(guid, *this, lpInputDataStruct, i_temporaryMemoryManager);
	}
...
{
	// 作成
	Gravisbell::Layer::NeuralNetwork::MergeAverage_LayerData_GPU* pLayerData = new Gravisbell::Layer::NeuralNetwork::MergeAverage_LayerData_GPU(guid);
	if(pLayerData == NULL)
		return NULL;
