...
// CPU処理用
//======================================
#ifndef __MergeAverage_CPU_H__
#define __MergeAverage_CPU_H__
...
class MergeAverage_CPU : public MergeAverage_Base
{
private:
	// データ本体
	class MergeAverage_LayerData_CPU& layerData;
...
public:
	/** コンストラクタ */
	MergeAverage_CPU(Gravisbell::GUID guid, class MergeAverage_LayerData_CPU& i_layerData, const std::vector<IODataStruct>& i_lpInputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~MergeAverage_CPU();
