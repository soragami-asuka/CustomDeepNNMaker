...
// GPU処理用
//======================================
#ifndef __MergeMax_GPU_H__
#define __MergeMax_GPU_H__
...
class MergeMax_GPU : public MergeMax_Base
{
private:
	// データ本体
	class MergeMax_LayerData_GPU& layerData;
...
public:
	/** コンストラクタ */
	MergeMax_GPU(Gravisbell::GUID guid, class MergeMax_LayerData_GPU& i_layerData, const std::vector<IODataStruct>& i_lpInputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~MergeMax_GPU();
