...
namespace NeuralNetwork {
	...
	//===========================
	/** コンストラクタ */
	MergeMax_LayerData_CPU::MergeMax_LayerData_CPU(const Gravisbell::GUID& guid)
		:	MergeMax_LayerData_Base(guid)
	{
	}
	/** デストラクタ */
	MergeMax_LayerData_CPU::~MergeMax_LayerData_CPU()
	{
	}
	...
	ILayerBase* MergeMax_LayerData_CPU::CreateLayer(const Gravisbell::GUID& guid, const IODataStruct i_lpInputDataStruct[], U32 i_inputLayerCount, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager)
	{
		...
		return new CNNMult2SingleLayerBase_CPU<MergeMax_CPU,MergeMax_LayerData_CPU>(guid, *this, lpInputDataStruct, i_temporaryMemoryManager);
	}
...
{
	// 作成
	Gravisbell::Layer::NeuralNetwork::MergeMax_LayerData_CPU* pLayerData = new Gravisbell::Layer::NeuralNetwork::MergeMax_LayerData_CPU(guid);
	if(pLayerData == NULL)
		return NULL;
