...
// プーリングレイヤーのデータ
//======================================
#ifndef __MergeMax_DATA_BASE_H__
#define __MergeMax_DATA_BASE_H__
...
namespace NeuralNetwork {
	...
	public:
		/** コンストラクタ */
		MergeMax_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~MergeMax_LayerData_Base();
