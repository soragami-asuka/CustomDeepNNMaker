...
namespace NeuralNetwork {
	...
	//===========================
	/** コンストラクタ */
	MergeMax_LayerData_GPU::MergeMax_LayerData_GPU(const Gravisbell::GUID& guid)
		:	MergeMax_LayerData_Base(guid)
	{
	}
	/** デストラクタ */
	MergeMax_LayerData_GPU::~MergeMax_LayerData_GPU()
	{
	}
	...
	ILayerBase* MergeMax_LayerData_GPU::CreateLayer(const Gravisbell::GUID& guid, const IODataStruct i_lpInputDataStruct[], U32 i_inputLayerCount, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager)
	{
		...
		return new CNNMult2SingleLayerBase_GPU<MergeMax_GPU,MergeMax_LayerData_GPU>(guid, *this, lpInputDataStruct, i_temporaryMemoryManager);
	}
...
{
	// 作成
	Gravisbell::Layer::NeuralNetwork::MergeMax_LayerData_GPU* pLayerData = new Gravisbell::Layer::NeuralNetwork::MergeMax_LayerData_GPU(guid);
	if(pLayerData == NULL)
		return NULL;
