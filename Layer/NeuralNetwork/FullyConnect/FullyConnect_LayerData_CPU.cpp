...
namespace NeuralNetwork {
	...
	/** 初期化. バッファからデータを読み込む
		...
		@return	成功した場合0 */
	ErrorCode FullyConnect_LayerData_CPU::InitializeFromBuffer(const BYTE* i_lpBuffer, U64 i_bufferSize, S64& o_useBufferSize)
	{
	...
	S64 FullyConnect_LayerData_CPU::WriteToBuffer(BYTE* o_lpBuffer)const
	{
