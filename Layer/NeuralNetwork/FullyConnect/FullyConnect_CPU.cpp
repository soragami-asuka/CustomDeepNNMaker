...
namespace NeuralNetwork {
	...
	/** コンストラクタ */
	FullyConnect_CPU::FullyConnect_CPU(Gravisbell::GUID guid, FullyConnect_LayerData_CPU& i_layerData, const IODataStruct& i_inputDataStruct)
	...
	ErrorCode FullyConnect_CPU::GetOutputBuffer(BATCH_BUFFER_POINTER o_lpOutputBuffer)const
	{
		...
		memcpy(o_lpOutputBuffer, &this->lpOutputBuffer[0], sizeof(F32)*outputBufferCount * this->GetBatchSize());
