 ...
 * Text      : 全結合レイヤー.
--------------------------------------------*/
#ifndef __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_FullyConnect_H__
#define __GRAVISBELL_NEURALNETWORK_LAYER_FUNC_FullyConnect_H__
...
#endif // __GRAVISBELL_NEURAULNETWORK_LAYER_FUNC_FullyConnect_H__
