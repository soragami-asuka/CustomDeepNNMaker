...
// CPU処理用
//======================================
#ifndef __ExponentialNormalization_CPU_H__
#define __ExponentialNormalization_CPU_H__
...
class ExponentialNormalization_CPU : public ExponentialNormalization_Base
{
private:
	// データ本体
	class ExponentialNormalization_LayerData_CPU& layerData;
...
public:
	/** コンストラクタ */
	ExponentialNormalization_CPU(Gravisbell::GUID guid, class ExponentialNormalization_LayerData_CPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~ExponentialNormalization_CPU();
