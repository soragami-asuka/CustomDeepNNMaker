...
// 出力信号分割レイヤーのデータ
//======================================
#ifndef __CHOOSEBOX_DATA_BASE_H__
#define __CHOOSEBOX_DATA_BASE_H__
...
namespace NeuralNetwork {
	...
	public:
		/** コンストラクタ */
		ChooseBox_LayerData_Base(const Gravisbell::GUID& guid);
		/** デストラクタ */
		virtual ~ChooseBox_LayerData_Base();
