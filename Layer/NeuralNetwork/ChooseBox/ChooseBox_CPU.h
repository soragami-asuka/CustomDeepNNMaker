...
// CPU処理用
//======================================
#ifndef __CHOOSEBOX_CPU_H__
#define __CHOOSEBOX_CPU_H__
...
class ChooseBox_CPU : public ChooseBox_Base
{
private:
	// データ本体
	class ChooseBox_LayerData_CPU& layerData;
...
public:
	/** コンストラクタ */
	ChooseBox_CPU(Gravisbell::GUID guid, class ChooseBox_LayerData_CPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~ChooseBox_CPU();
