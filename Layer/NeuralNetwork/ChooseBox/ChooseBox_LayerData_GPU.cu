...
namespace NeuralNetwork {
	...
	//===========================
	/** コンストラクタ */
	ChooseBox_LayerData_GPU::ChooseBox_LayerData_GPU(const Gravisbell::GUID& guid)
		:	ChooseBox_LayerData_Base(guid)
	{
	}
	/** デストラクタ */
	ChooseBox_LayerData_GPU::~ChooseBox_LayerData_GPU()
	{
	}
	...
	ILayerBase* ChooseBox_LayerData_GPU::CreateLayer(const Gravisbell::GUID& guid, const IODataStruct i_lpInputDataStruct[], U32 i_inputLayerCount, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager)
	{
		if(this->CheckCanUseInputDataStruct(i_lpInputDataStruct, i_inputLayerCount) == false)
			return NULL;

		return new CNNSingle2SingleLayerBase_GPU<ChooseBox_GPU,ChooseBox_LayerData_GPU>(guid, *this, i_lpInputDataStruct[0], i_temporaryMemoryManager);
	}
...
{
	// 作成
	Gravisbell::Layer::NeuralNetwork::ChooseBox_LayerData_GPU* pLayerData = new Gravisbell::Layer::NeuralNetwork::ChooseBox_LayerData_GPU(guid);
	if(pLayerData == NULL)
		return NULL;
