...
// GPU処理用
//======================================
#ifndef __CHOOSEBOX_GPU_H__
#define __CHOOSEBOX_GPU_H__
...
class ChooseBox_GPU : public ChooseBox_Base
{
private:
	// データ本体
	class ChooseBox_LayerData_GPU& layerData;
...
public:
	/** コンストラクタ */
	ChooseBox_GPU(Gravisbell::GUID guid, class ChooseBox_LayerData_GPU& i_layerData, const IODataStruct& i_inputDataStruct, Gravisbell::Common::ITemporaryMemoryManager& i_temporaryMemoryManager);
	/** デストラクタ */
	virtual ~ChooseBox_GPU();
...
public:
	...
	//===========================
	/** レイヤーデータを取得する */
	ChooseBox_LayerData_Base& GetLayerData();
	const ChooseBox_LayerData_Base& GetLayerData()const;
