========================================================================
    ダイナミック リンク ライブラリ: BatchDataNoListGenerator プロジェクトの概要
========================================================================

この BatchDataNoListGenerator DLL は、AppWizard により作成されました。

このファイルには、BatchDataNoListGenerator アプリケーションを構成する各ファイルの内容の概要が含まれています。


BatchDataNoListGenerator.vcxproj
...
BatchDataNoListGenerator.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、BatchDataNoListGenerator.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。
